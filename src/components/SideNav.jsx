...
function SideNav() {
  ...
  return (
    <div className="w-1/5 h-screen sticky shadow-xl bg-slate-400  flex flex-col justify-evenly items-center rounded-r-xl bg-gradient-to-b from-purple-400 to-pink-400 max-w-[250px] min-w-[200px]">
