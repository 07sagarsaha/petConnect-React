...
const Posts = () => {
  ...
  return (
    <>
    {post.map(post => (
    <div key={post.id} className="text-xl relative p-6 m-8 flex-col justify-center items-center shadow-skew h-max min-h-12 w-[60%] min-w-64 rounded-2xl animate-postAnim3 transition-all ease-in-out duration-200">
