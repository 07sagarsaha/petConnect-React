...
const Button = ({buttonName}) => {
  ...
  return (
    <>
    <button className={`text-3xl absolute left-[1050px] top-10 rounded-lg p-4 hover:text-red-600 animate-postButtonAnim2 transition-all duration-500 ${!isClicked && `hidden`}`} onClick={handleClickEvent}>{isClicked && 'x'}</button>
