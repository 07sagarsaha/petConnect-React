  ...
  return (
    <>
      <div className="flex flex-col items-center bg-base-200 text-gray-800 min-h-screen p-4 rounded-lg">
        ...
        <div className="w-full flex max-sm:flex-col lg:flex-row gap-4 mb-4">
          {/* Search Container */}
          <div
          ...
          >
            ...
            >
              <input
                ...
                className="w-full outline-none bg-base-100 p-4 text-[16px] shadow-lg rounded-2xl"
          ...
          {/* New Post Button Container - Adjusted width and styling */}
          <div className="lg:w-[300px] w-full">
            <Button
              buttonName="New Post"
              icon={<IoMdAddCircleOutline className="size-7 mr-2" />}
              submitName="Post"
              className="w-full h-full" // Add this class to ensure button fills container
            />
          </div>
        </div>

        {/* Modal Backdrop - Adjusted z-index */}
        {isSearchModalOpen && (
